"""
Django settings for LoverMatch_Django project.
...
SECRET_KEY = 'gnmo#2w!6jn2-$j+l@6=-%x(c%)qdi*48@#%lv5w+1_ttvo3u^'
...
INSTALLED_APPS = [
    'lovermatch.apps.LovermatchConfig',
...
WSGI_APPLICATION = 'LoverMatch_Django.wsgi.application'
